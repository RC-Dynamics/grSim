...
void protobuf_AssignDesc_grSim_5fCommands_2eproto() {
  ...
  static const int grSim_Robot_Command_offsets_[13] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(grSim_Robot_Command, isteamyellow_),
  ...
  static const int grSim_Commands_offsets_[2] = {
...
void protobuf_AddDesc_grSim_5fCommands_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\024grSim_Commands.proto\"\200\002\n\023grSim_Robot_C"
    "ommand\022\024\n\014isteamyellow\030\001 \002(\010\022\n\n\002id\030\002 \002(\r"
    "\022\022\n\nkickspeedx\030\003 \002(\002\022\022\n\nkickspeedz\030\004 \002(\002"
    "\022\022\n\nveltangent\030\005 \002(\002\022\021\n\tvelnormal\030\006 \002(\002\022"
    "\022\n\nvelangular\030\007 \002(\002\022\017\n\007spinner\030\010 \002(\010\022\023\n\013"
    "wheelsspeed\030\t \002(\010\022\016\n\006wheel1\030\n \001(\002\022\016\n\006whe"
    "el2\030\013 \001(\002\022\016\n\006wheel3\030\014 \001(\002\022\016\n\006wheel4\030\r \001("
    "\002\"Q\n\016grSim_Commands\022\021\n\ttimestamp\030\001 \002(\001\022,"
    "\n\016robot_commands\030\002 \003(\0132\024.grSim_Robot_Com"
    "mand", 364);
...
const int grSim_Robot_Command::kIsteamyellowFieldNumber;
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(29)) goto parse_kickspeedx;
        break;
      }
      ...
      case 3: {
        ...
        if (input->ExpectTag(37)) goto parse_kickspeedz;
        break;
      }
      ...
      case 4: {
        ...
        if (input->ExpectTag(45)) goto parse_veltangent;
        break;
      }
      ...
      case 5: {
        ...
        if (input->ExpectTag(53)) goto parse_velnormal;
        break;
      }
      ...
      case 6: {
        ...
        if (input->ExpectTag(61)) goto parse_velangular;
        break;
      }
      ...
      case 7: {
        ...
        if (input->ExpectTag(64)) goto parse_spinner;
        break;
      }
      ...
      case 8: {
        ...
        if (input->ExpectTag(72)) goto parse_wheelsspeed;
        break;
      }
      ...
      case 9: {
        ...
        if (input->ExpectTag(85)) goto parse_wheel1;
        break;
      }
      ...
      case 10: {
        ...
        if (input->ExpectTag(93)) goto parse_wheel2;
        break;
      }
      ...
      case 11: {
        ...
        if (input->ExpectTag(101)) goto parse_wheel3;
        break;
      }
      ...
      case 12: {
        ...
        if (input->ExpectTag(109)) goto parse_wheel4;
        break;
      }
...
void grSim_Robot_Command::SerializeWithCachedSizes(
  ...
  // required bool isteamyellow = 1;
  if (has_isteamyellow()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(1, this->isteamyellow(), output);
  }
  ...
  // required float kickspeedx = 3;
  if (has_kickspeedx()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(3, this->kickspeedx(), output);
  }

  // required float kickspeedz = 4;
  if (has_kickspeedz()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(4, this->kickspeedz(), output);
  }

  // required float veltangent = 5;
  if (has_veltangent()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(5, this->veltangent(), output);
  }

  // required float velnormal = 6;
  if (has_velnormal()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(6, this->velnormal(), output);
  }

  // required float velangular = 7;
  if (has_velangular()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(7, this->velangular(), output);
  }

  // required bool spinner = 8;
  if (has_spinner()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(8, this->spinner(), output);
  }

  // required bool wheelsspeed = 9;
  if (has_wheelsspeed()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(9, this->wheelsspeed(), output);
  }

  // optional float wheel1 = 10;
  if (has_wheel1()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(10, this->wheel1(), output);
  }

  // optional float wheel2 = 11;
  if (has_wheel2()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(11, this->wheel2(), output);
  }

  // optional float wheel3 = 12;
  if (has_wheel3()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(12, this->wheel3(), output);
  }

  // optional float wheel4 = 13;
  if (has_wheel4()) {
    ::google::protobuf::internal::WireFormatLite::WriteFloat(13, this->wheel4(), output);
  }
...
::google::protobuf::uint8* grSim_Robot_Command::InternalSerializeWithCachedSizesToArray(
  ...
  // required bool isteamyellow = 1;
  if (has_isteamyellow()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(1, this->isteamyellow(), target);
  }
  ...
  // required float kickspeedx = 3;
  if (has_kickspeedx()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(3, this->kickspeedx(), target);
  }

  // required float kickspeedz = 4;
  if (has_kickspeedz()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(4, this->kickspeedz(), target);
  }

  // required float veltangent = 5;
  if (has_veltangent()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(5, this->veltangent(), target);
  }

  // required float velnormal = 6;
  if (has_velnormal()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(6, this->velnormal(), target);
  }

  // required float velangular = 7;
  if (has_velangular()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(7, this->velangular(), target);
  }

  // required bool spinner = 8;
  if (has_spinner()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(8, this->spinner(), target);
  }

  // required bool wheelsspeed = 9;
  if (has_wheelsspeed()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(9, this->wheelsspeed(), target);
  }

  // optional float wheel1 = 10;
  if (has_wheel1()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(10, this->wheel1(), target);
  }

  // optional float wheel2 = 11;
  if (has_wheel2()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(11, this->wheel2(), target);
  }

  // optional float wheel3 = 12;
  if (has_wheel3()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(12, this->wheel3(), target);
  }

  // optional float wheel4 = 13;
  if (has_wheel4()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteFloatToArray(13, this->wheel4(), target);
  }
...
// required bool isteamyellow = 1;
bool grSim_Robot_Command::has_isteamyellow() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
void grSim_Robot_Command::set_has_isteamyellow() {
  _has_bits_[0] |= 0x00000001u;
}
void grSim_Robot_Command::clear_has_isteamyellow() {
  _has_bits_[0] &= ~0x00000001u;
}
void grSim_Robot_Command::clear_isteamyellow() {
  isteamyellow_ = false;
  clear_has_isteamyellow();
}
 bool grSim_Robot_Command::isteamyellow() const {
  // @@protoc_insertion_point(field_get:grSim_Robot_Command.isteamyellow)
  return isteamyellow_;
}
 void grSim_Robot_Command::set_isteamyellow(bool value) {
  set_has_isteamyellow();
  isteamyellow_ = value;
  // @@protoc_insertion_point(field_set:grSim_Robot_Command.isteamyellow)
}
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 2: {
        ...
        if (input->ExpectTag(18)) goto parse_loop_robot_commands;
  ...
  for (unsigned int i = 0, n = this->robot_commands_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        2, this->robot_commands(i), false, target);
  }
