...
class grSim_Robot_Command : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:grSim_Robot_Command) */ {
 public:
  ...
  static const int kIsteamyellowFieldNumber = 1;
  ...
  static const int kKickspeedxFieldNumber = 3;
  ...
  static const int kKickspeedzFieldNumber = 4;
  ...
  static const int kVeltangentFieldNumber = 5;
  ...
  static const int kVelnormalFieldNumber = 6;
  ...
  static const int kVelangularFieldNumber = 7;
  ...
  void clear_spinner();
  static const int kSpinnerFieldNumber = 8;
  bool spinner() const;
  ...
  static const int kWheelsspeedFieldNumber = 9;
  ...
  void clear_wheel1();
  static const int kWheel1FieldNumber = 10;
  float wheel1() const;
  ...
  void clear_wheel2();
  static const int kWheel2FieldNumber = 11;
  float wheel2() const;
  ...
  void clear_wheel3();
  static const int kWheel3FieldNumber = 12;
  float wheel3() const;
  ...
  void clear_wheel4();
  static const int kWheel4FieldNumber = 13;
  float wheel4() const;
...
// required bool isteamyellow = 1;
inline bool grSim_Robot_Command::has_isteamyellow() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void grSim_Robot_Command::set_has_isteamyellow() {
  _has_bits_[0] |= 0x00000001u;
}
inline void grSim_Robot_Command::clear_has_isteamyellow() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void grSim_Robot_Command::clear_isteamyellow() {
  isteamyellow_ = false;
  clear_has_isteamyellow();
}
inline bool grSim_Robot_Command::isteamyellow() const {
  // @@protoc_insertion_point(field_get:grSim_Robot_Command.isteamyellow)
  return isteamyellow_;
}
inline void grSim_Robot_Command::set_isteamyellow(bool value) {
